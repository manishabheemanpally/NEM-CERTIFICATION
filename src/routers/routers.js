...
mongoose.connect("mongodb+srv://pasapugazh534:a6vTqbROxOpARtJO@cluster0.vgbbwjw.mongodb.net/", {
...
db.once("open", (_) => {
    console.log("Database connected:", "mongodb+srv://pasapugazh534:a6vTqbROxOpARtJO@cluster0.vgbbwjw.mongodb.net/");
});
db.on("error", (err) => {
